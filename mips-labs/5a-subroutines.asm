...
add $a1, $v0, $0	#move integer from v0 to register $s0
...
#-----------------------
 ...
 getFact:
 add $t4, $a1, $0	#move integer from v0 to register $s0
 #Conditional Section
 #-------------------------------------
 ...
 #-------------------------------------
 loop1: beq $s1, $t4, exitLoop1  # loop equal to counter
    #----------------------------------
     li $v0, 4	 #print the string
    ...
    #----------------------------------
     ...
     addi $t4, $t4, -1  # counter adding 2 to each loop through
